...
class BgFirma{
    ...
    public function __construct($total, $merchantId, $subtotal, $taxes, $paymentDate, $paymentMethod, $transactionType, $orderId, $successUrl, $failUrl, $domain, $secretToken, $sandbox, $jwtToken, $tel)
    {
        $this->total = $total;
